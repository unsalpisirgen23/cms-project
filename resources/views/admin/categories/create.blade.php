            ...
            <div class="container-fluid">
                ...
                <div class="card card-default">
                    <div class="card-header">
                        <h3 class="card-title">Kategori Ekleyin</h3>
...
@csrf
    ...
    <small>*Eğer üst kategorisi yuksa boş bırakınız</small>
                                    <select class="form-control select2 select2-danger"  data-dropdown-css-class="select2-danger" style="width: 100%; height: 10px">
                    ...
                    <div class="card-footer">
                        <div class="form-group">
                            ...
                            <input type="text" title="title" name="title" class="form-control" id="exampleInputEmail1" placeholder="Kategori Adı">
                        </div>
                        <div class="form-group">
