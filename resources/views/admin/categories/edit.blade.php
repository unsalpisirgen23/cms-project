                ...
                <div class="card card-default">
                            ...
                            <div class="row">
                                <div class="col-12 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2 select2-danger" name="parent_id" data-dropdown-css-class="select2-danger" style="width: 100%; height: 10px">
                                            @foreach($categories as $p_category)
                                            <option value="{!! $p_category->id !!}" @if($p_category->id == $category->id) disabled @endif>{!! $p_category->title !!}</option>
                    ...
                    <div class="card-footer">
                        <div class="form-group">
                            ...
                            <input type="text" title="title" name="title" class="form-control" id="exampleInputEmail1" placeholder="Kategori Adı" value="{!! $category->title !!}">
                        </div>
                        <div class="form-group">
